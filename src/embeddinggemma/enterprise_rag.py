#!/usr/bin/env python3
"""
Enterprise RAG für Code-Analyse mit LlamaIndex, Qdrant und EmbeddingGemma
...
class EnterpriseCodeRAG:
    """
    Enterprise-grade RAG für Code-Analyse mit semantischem Verständnis
    """
    ...
    def __init__(self, 
                 ...
                 debug: bool = False):
        """
        Initialisiert die Enterprise-RAG mit Qdrant und LlamaIndex
        
        Args:
            qdrant_url: Qdrant Server URL
            qdrant_api_key: API Key für Qdrant (optional für local)
            collection_name: Name der Qdrant Collection
            embedding_model: EmbeddingGemma Modell
            llm_model: LLM für Generierung
        """
        ...
        print(f"✅ EnterpriseCodeRAG initialisiert mit Qdrant: {qdrant_url}")
